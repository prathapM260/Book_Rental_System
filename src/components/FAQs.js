...
const FAQs = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-16 bg-gradient-to-b from-blue-500 to-white py-10 shadow-lg">
      <h2 className="text-4xl mb-8 text-gray-800">Frequently asked questions</h2>
      <div className="space-y-4">
          {faqData.map((faq, index) => (
            <div key={index} data-aos="fade-up" data-aos-delay={index * 100}>
              <div className="bg-white border border-gray-200 rounded-md">
                <button
                  onClick={() => toggleAccordion(index)}
                  className="w-full text-left p-4 focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm"
                >
